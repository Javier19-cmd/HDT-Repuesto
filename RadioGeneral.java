...
public interface RadioGeneral {
        ...
        boolean asignar(int num);     //Creará una arraylist o array con las emisoras de am y fm.
        boolean emisora(int num);    //Enseña la lista de estaciones de radio ya sea que esté en am o fm.
